...
<body>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        ...
        <input type="text" name="aihe" class="form-control" placeholder="Syötä koulutuksen aihe" required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">          
        <input type="datetime" name="alkamisaika" class="form-control" placeholder="Syötä koulutuksen alkamisaika" required>
      </div>
    </div>


 <div class="form-group">
      <label class="control-label col-sm-2" for="paattymisaika">Päättymisaika:</label>
      <div class="col-sm-4">          
        <input type="datetime" name="paattymisaika" class="form-control" placeholder="Syötä koulutuksen päättymisaika" required>
      </div>
    </div>
...
<div class="form-group">
      ...
      <div class="col-sm-4">          
        <input type="text" name="paikka_id" class="form-control" placeholder="Syötä koulutuksen paikka" required>
      </div>
    </div>
...
<div class="form-group">
      ...
      <div class="col-sm-4">          
        <input type="text" name="opettaja_id" class="form-control" placeholder="Syötä koulutuksen opettaja" required>
      </div>
    </div>
